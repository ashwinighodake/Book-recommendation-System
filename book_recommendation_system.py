...
Between 3 and 4
Between 4 and 5
Broadly, the recommendations then consider the average ratings and ratings count for the query entered.
'''
        ...
        [
            ...
            dcc.Dropdown(
                ...
                options=[
                    ...
                    {'label': 'Top 30 books with more pages than  1000', 'value': 'booksWithMorePages'},
